    ...
    return f"""
        ...
        <worldbody>
            ...
            <body name="link1" pos="0 0 0" euler="0 0 0">         
                <geom type="cylinder" pos="{a / 2} 0 0" size="0.002 {a / 2}" euler="0 90 0" rgba="0.21 0.32 0.82 0.5" contype="0"/>

                <body name="link2" pos="{a} 0 0" euler="0 0 0">
                    <joint name="A" type="hinge" axis="0 1 0" stiffness="0" springref="0" damping="0"/>     
                    <geom type="cylinder" pos="{c / 2} 0 0" size="0.002 {c / 2}" euler="0 90 0" rgba="0.42 0.32 0.12 0.5" contype="0"/>

                    <geom name="pulley1" type="cylinder" size="{R1 / 2} 0.001" pos="0 0 0" euler="90 0 0" rgba="0.42 0.32 0.12 0.5" contype="0"/>
                    <site name="side_r1_t1" pos="0 0 {-R1 / 2 - 0.002}" type="sphere" size="0.001"/>
                    <site name="side_r1_t2" pos="0 0 {R1 / 2 + 0.002}" type="sphere" size="0.001"/>
                    ...
                    <body name="link3" pos="{c} 0 0" euler="0 0 0">
                        ...
                        <geom type="cylinder" pos="{b / 2} 0 0" size="0.002 {b / 2}" euler="0 90 0" rgba="0.34 0.65 0.84 0.5" contype="0"/>
                        <geom type="box" pos="{b} 0 0" size="0.002 0.002 {R2 / 2}" rgba="0.34 0.65 0.84 0.5" mass="0" contype="0"/>

                        <site name="t1_end" pos="{b} 0 {R2 / 2}" type="sphere" size="0.002"/>
                        <site name="t2_end" pos="{b} 0 {-R2 / 2}" type="sphere" size="0.002"/>

                        <geom name="pulley2" type="cylinder" size="{R2 / 2} 0.001" pos="0 0 0" euler="90 0 0" rgba="0.34 0.65 0.84 0.5" contype="0"/>
                        <site name="side_r2_t1" pos="0 0 {R2 / 2 + 0.002}" type="sphere" size="0.001"/>
                        <site name="side_r2_t2" pos="0 0 {-R2 / 2 - 0.002}" type="sphere" size="0.001"/>
                        <site name="pulley2_side" pos="0 0 0" type="sphere" size="0.001"/>

                        <site name="effector" pos="{b} 0 0" type="sphere" size="0.001"/>
                    </body>
                </body>
            </body>
        </worldbody>
        ...
        <tendon>
            <spatial name="tendon1_1" width="0.001" stiffness="{stiffness}" damping="10" springlength="0.005">
                <site site="t1_wall"/>
        ...
        <tendon>
            <spatial name="tendon2_1" width="0.001" stiffness="{stiffness}" damping="10" springlength="0.005">
                <site site="t2_wall"/>
        ...
        <actuator>
            <motor name="motor_t1" tendon="tendon1_1" gear="1" ctrlrange="-20 20"/>
            <motor name="motor_t2" tendon="tendon2_1" gear="1" ctrlrange="-20 20"/>
        </actuator>
